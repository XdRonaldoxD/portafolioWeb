        ...
        experiencia: [
            {
                ...
                pdfUrl: "/Certificados/certificado_duran-signed.pdf",
                descripcion: `Formé parte del equipo de desarrollo participando en el mantenimiento y evolución de un sistema empresarial construido bajo arquitectura hexagonal, contribuyendo a la implementación de código limpio, desacoplado y escalable. Estuve a cargo del desarrollo de nuevas funcionalidades y la corrección de incidencias tanto en Laravel como en PHP nativo para el backend, así como en la implementación de mejoras en el frontend utilizando Vue.js.
                            Asimismo, participé en la creación y consumo de APIs RESTful aplicando buenas prácticas mediante métodos HTTP como GET, POST, PUT y DELETE a través de Axios. También realicé la conexión y gestión de bases de datos SQL Server mediante FortiClient VPN, ejecutando consultas, inserciones y actualizaciones de acuerdo a los requerimientos del sistema, además de participar en la generación de reportes dinámicos en formatos PDF y Excel desde la aplicación.
                            Adicionalmente, colaboré en la validación de funcionalidades críticas mediante pruebas unitarias previas a su despliegue. Durante el desarrollo del proyecto trabajé bajo la metodología ágil Scrum, participando en reuniones semanales, gestionando tareas y realizando seguimiento del proyecto mediante Azure DevOps, colaborando con el equipo para el cumplimiento de los objetivos definidos en cada sprint y en la elaboración de documentación técnica para el pase a producción de los desarrollos realizados.`
            },
            {
